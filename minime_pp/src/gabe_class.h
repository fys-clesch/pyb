...
class gabe
{
    ...
    public:
        ...
        void get_Waist_z_Elliptic(const double wx0,
                                  ...
                                  double *res_pt wxz,
                                  double *res_pt wyz);
        double get_GaussianIntensity_Elliptic(const uint x,
                                              const uint y,
                                              const double wxz,
                                              const double wyz,
                                              const double x_off,
                                              const double y_off);
        void get_GaussianIntensity_Elliptic_Array_z(const double wx0,
                                                    const double wy0,
                                                    const double z,
                                                    const double x_off,
                                                    const double y_off,
                                                    ...
                                                    const uint row,
                                                    const uint col);
        void get_GaussianIntensity_Elliptic_Array(const double wxz,
                                                  const double wyz,
                                                  const double x_off,
                                                  const double y_off,
                                                  double *out,
                                                  const uint row,
                                                  const uint col);
        void get_RayleighRange_Via_2Widths(const double *res_pt m1,
        ...
        double get_BeamRadiusX(const double *res_pt m,
                               const uchar *res_pt bad,
                               const uint row,
                               const uint col,
                               const bool noisy = true);
        double get_BeamRadiusY(const double *res_pt m,
                               const uchar *res_pt bad,
                               const uint row,
                               const uint col,
                               const bool noisy = true);
